...
@SpringBootApplication(scanBasePackages = {"com.atd.utilities.kafkalogger", "com.atd.microservices.core.ediaggregator"})
@EnableSwagger2
public class EDIAggregatorApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(EDIAggregatorApplication.class, args);
	}
